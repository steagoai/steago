...
export function StackedLayout({
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full flex-col bg-white lg:bg-zinc-100 dark:bg-zinc-950 dark:lg:bg-zinc-900">
      ...
      {/* Navbar */}
      <header className="flex items-center px-6 lg:px-8">
      ...
      <main className="flex flex-1 flex-col pb-2 lg:px-2">
        <div className="grow p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:bg-zinc-950 dark:lg:ring-white/10">
