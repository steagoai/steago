  ...
  return (
    <Headless.MenuItems
      ...
      className={clsx(
        ...
        'gap-1 [--anchor-gap:theme(spacing.2)] [--anchor-padding:theme(spacing.1)]',
        // Base styles
...
export function DropdownItem({
  ...
  const classes = clsx(
    ...
    // Focus
    'data-[focus]:bg-zinc-200 dark:data-[focus]:bg-zinc-700 dark:data-[focus]:text-white',
    // Disabled state
    ...
    '[&>[data-slot=icon]]:text-zinc-500 [&>[data-slot=icon]]:dark:text-zinc-400 [&>[data-slot=icon]]:data-[focus]:dark:text-white',
    // Avatar
...
export function DropdownHeader({
  ...
  return (
    <div
      ...
      className={clsx(
        className,
        'col-span-5 px-3.5 pb-1 pt-2.5 text-sm text-gray-500 sm:px-3'
      )}
    />
  );
}
